...
if (bread>=2 and pb>=1 and jelly>=1):
	print "I can make this many sandwiches:{0}".format(min(bread/2,pb,jelly))
else:
	print "Looks like I don't have a lunch today"

# To satisfy the third goal:
#		Continue from the second goal, and add:
#		If you have an odd number of slices of bread* and odd amount of peanut butter and jelly, print a message like before, 
#		but mention that you can make an open-face sandwich, too.
#		If you don't have enough ingredients; still print the same message as before
#		* To calculate whether you have an odd number, 
		#see https://github.com/shannonturner/python-lessons/blob/master/section_01_(basics)/simple_math.py
if (bread/2 != 0 and (pb+jelly)/2 != 0):
	print "And some open-faced sandwiches!"
...
if (bread>2 and pb>2 and jelly <1):
	print "I can make peanut butter sandwiches"
elif (bread>2 and pb>2 and jelly>1 and pb>jelly and bread*2>jelly):
	print "I can make {0} pb&js and {1} peanut butter sandwich".format(jelly/1, pb-jelly)


# To satisfy the fifth goal:
#		Continue from the fourth goal, but this time if you don't have enough ingredients, print a message that tells you 
#		which ones you're missing.
if bread<2:
	print "More bread is needed"
elif pb<1:
	print "Peanut butter is needed"
elif jelly <1:
	"Jelly is needed"
